<template>
    <section>
        <form v-on:submit.prevent="submit">
            <div class="container bg-lightblue mx-auto px-6 text-gray-500 ">
                 <div class="flex">
                </div>
                <p class="block uppercase tracking-wide font-bold text-7xl"> Add New Product</p>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="category">Category</label>
                    <input  v-model="product.category" placeholder="Category" class="bg-white shadow-md rounded px-8 border py-2 px-3 text-grey-darkest" type="text" name="category" id="category">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="name">Name</label>
                    <input v-model="product.name" placeholder="Name" class="bg-white shadow-md rounded px-8 border py-2 px-3  text-grey-darkest" type="text" name="name" id="name">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="size">Size</label>
                    <input v-model="product.size" placeholder="Size" class="bg-white shadow-md rounded px-8 border py-2 px-3  text-grey-darkest" type="text" name="size" id="color">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="brand">Brand</label>
                    <input  v-model="product.brand" placeholder="Brand" class="bg-white shadow-md rounded px-8 border py-2 px-3 text-grey-darkest" type="text" name="brand" id="brand">
                </div>
                <div class="flex flex-col mb-4">
